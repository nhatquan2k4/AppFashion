...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, ImageBackground, Keyboard, TouchableWithoutFeedback, Alert, ActivityIndicator } from 'react-native';
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    if (!password) {
      Alert.alert('Error', 'Vui lòng nhập mật khẩu');
      return;
    }
    ...
    try {
      // Giả lập xử lý đăng nhập (thay bằng API thực tế nếu có)
      setTimeout(() => {
        setLoading(false);
